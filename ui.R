  ...
  tags$head(
          ...
          navbarPage("Crime DC",id='nav',
                     ...
                     absolutePanel(id = "controls",class = "panel panel-default", fixed = TRUE, draggable = TRUE,
                                   ...
                                   width = 350, height = "auto", style = "opacity: .78",
                                           
                                   h4("Crime DC - Last 30 Days"), br(), 
                                   paste("This Panel is Draggable.."), br(),
                                   paste("Please wait till map and charts load."),
                                   br(),
                                   paste("Charts will update based on the viewable area in the map"),
                                   br(),
        ...
        paste(' | '),
        a("github",href="https://github.com/neilkutty/DC_Crime_Data"),
        paste(' | '),
